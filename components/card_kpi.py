...
def card_kpi(titulo, valor, icone, cor, subtitulo=None):
    ...
    html = f"""
<div style="background-color:#111827; padding:18px; border-radius:18px; border:1px solid #1f2937; height:145px; display:flex; flex-direction:column; justify-content:space-between; box-shadow:0 4px 14px rgba(0,0,0,0.20);">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        <span style="font-size:14px; color:#cbd5e1; font-weight:500; white-space:normal; line-height:1.3;">{titulo}</span>
